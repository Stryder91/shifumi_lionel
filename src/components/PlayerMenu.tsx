...
export const PlayerMenu = ({ handleNames }) => {
	...
	return(
		<div>
			...
			<a onClick={() => handleNames(playerNames.playerName)}  href="#_" className="px-5 py-2.5 relative rounded group overflow-hidden font-medium bg-yellow-50 text-yellow-600 inline-block">
